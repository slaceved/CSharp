...
namespace AVLTree
{
        ...
        where T : IComparable
    {
        ...
        private static void PreOrderTraversal(Action<T> action, AVLTreeNode<T> node)
        {
            while (true)
            {
                if (node == null) return;
        ...
        private static void PostOrderTraversal(Action<T> action, AVLTreeNode<T> node)
        {
            if (node == null) return;
        ...
        private static void InOrderTraversal(Action<T> action, AVLTreeNode<T> node)
        {
            while (true)
            {
                if (node != null)
        ...
        public IEnumerator<T> InOrderTraversal()
        {
            ...
            // when removing recursion we need to keep track of whether or not we should be going to the left node or the right nodes next.
            var goLeftNext = true;
